...
@section('page-title', 'Tambah Pemimpin Baru')

@section('content')
<div class="card" style="max-width: 800px; margin: 0 auto;">
    <div class="card-header">
        <h3><i class="fas fa-user-plus" style="color:var(--gold);margin-right:8px;"></i>Form Data Pemimpin</h3>
    </div>
    <div class="card-body">
        <p style="color: var(--text-mid); font-size: 14px; margin-bottom: 24px;">
            Gunakan formulir ini untuk menambahkan profil pemimpin atau pendeta ke dalam sistem gereja.
        </p>
        ...
        <form action="{{ route('admin.pastors.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-bottom: 24px;">
                ...
                <textarea name="description" id="description" rows="4" 
                    placeholder="Tuliskan biografi singkat atau visi pelayanan..." 
            ...
            <div class="form-group" style="margin-bottom: 30px;">
                ...
                <div id="drop-zone" style="border:2px dashed var(--border); border-radius:12px; padding:32px; text-align:center; background:#fafafa; transition:all 0.3s; cursor:pointer; position:relative;">
                    ...
                    <div id="upload-placeholder">
                        ...
                        <div style="font-weight:600; color:var(--text-dark); margin-bottom:4px;">Klik atau seret foto ke sini</div>
                        <div style="font-size:12px; color:var(--text-mid);">Format: JPEG, PNG, JPG. Ukuran maksimal 2MB. Disarankan rasio 1:1 (persegi).</div>
                    </div>

                    <div id="image-preview-container" style="display:none; flex-direction:column; align-items:center;">
                        <img id="image-preview" src="#" alt="Preview" style="max-width:200px; max-height:200px; border-radius:50%; box-shadow:var(--shadow-md); margin-bottom:12px; object-fit:cover; width:200px; height:200px;">
                        <div style="font-size:13px; color:var(--gold); font-weight:600;">
                            <i class="fas fa-check-circle"></i> Foto Terpilih: <span id="file-name" style="color:var(--text-dark);"></span>
                        </div>
