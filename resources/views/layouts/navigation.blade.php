    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="px-4 space-y-2">
                <a href="{{ route('login') }}" class="block px-4 py-2 text-gray-600 hover:text-gray-900">{{ __('Login') }}</a>
                <a href="{{ route('register') }}" class="block px-4 py-2 text-gray-600 hover:text-gray-900">{{ __('Register') }}</a>
            </div>
            @endauth
        </div>
    </div>
